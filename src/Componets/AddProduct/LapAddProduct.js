...
const LapAddProduct = () => {
    ...
    const onSubmit =data=>{
        const url = `https://ancient-brook-51356.herokuapp.com/laptop`;
        fetch(url, { 
         method: 'POST',
         headers: {
    ...
    return (
        <div>
        <div className="mt-4">
            <h2 className="text-center my-2 d-block text-2xl text-bold ">Please add  Laptop</h2>
